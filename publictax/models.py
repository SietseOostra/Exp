...
author = 'Sietse Oostra; Original code written by Christian Peters and Victor van Pelt'

doc = """
Public tax and cautionary statements: An extension of Dierynck, Jacob, Müller, Peters and van Pelt (2021) 
"""
...
class Constants(BaseConstants):
    ...
    num_rounds = 1
    completion_code = 'TAX_tiu_102021'
