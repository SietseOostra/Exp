...
mturk_hit_settings = {
    ...
    'title': 'Assess Corporate Tax Strategies ($0.83 for about 5.5 min)',
    'description': 'Assess corporate tax strategies of companies for $0.83 for about 5.5 minutes.',
    'frame_height': 500,
